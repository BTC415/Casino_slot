...
const AccessDenied = () => {
    ...
    return (
        <div style={{ height: '100vh', backgroundImage: `url(${VITE_API_ASSETS_ELSE_URL}res/bg-access-denied.png)`, backgroundColor: "black", backgroundSize: "cover" , color: 'white' }}>
            ...
            <div className="flex justify-center items-center w-full h-full">
                <div className="flex flex-col items-center text-center w-full">
                    ...
                    <img alt="astronaut" src={`${VITE_API_ASSETS_ELSE_URL}res/astronaut.gif`} className="max-w-[365px] w-full m-5 " />
                </div>
            </div>
        </div>
    )
