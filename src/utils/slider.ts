...
//         const APP_SCALE = Math.min(app.screen.width / Game_Category_Dimension[game_global_vars.gameId].gameBoard.width, app.screen.height / Game_Category_Dimension[game_global_vars.gameId].gameBoard.height) * info_dialog_wrapper_scale_ratio
...
//     const sliderWrapper = PIXI.Sprite.from(`${VITE_API_ASSETS_IMAGE_URL}jrsl/slider-track.png`)
//     const slider = PIXI.Sprite.from(`${VITE_API_ASSETS_IMAGE_URL}jrsl/slider-slider.png`)
...
//     const info_content_sprite = new PIXI.Sprite(PIXI.Texture.from(`${VITE_API_ASSETS_IMAGE_URL}${game_global_vars.gameId}/${mobileORdesktop}/${webpORpng}/info-content.${webpORpng}`))
